...
#ifndef INC_F446RE_H_
#define INC_F446RE_H_
...
/*
 * ARM Cortex Mx Processor Priority Register Address Calculatio
 */
...
typedef struct{
	...
	__vo uint32_t AHB1PENR;
	__vo uint32_t AHB2PENR;
	__vo uint32_t AHB3PENR;
	uint32_t      RESERVED4;
	...
	__vo uint32_t DCKCFGR2S;
}RCC_RegDef_t;

/*
 * Peripherial base register for EXTI
 */
typedef struct{
	__vo uint32_t IMR;
	__vo uint32_t EMR;
...
/*
 * Peripherial base register for SYSCFG
 */
typedef struct{
...
/*
 * Peripheral definations (Peripheral baseaddr typecasted to xxx_RegDef_t)
 */
...
#define UART4_PCCK_EN()         (RCC->APB2ENR |= (1 << 19))
#define UART5_PCCK_EN()         (RCC->APB1ENR |= (1 << 20))
#define USART4_PCCK_EN()        (RCC->APB1ENR |= (1 << 5))
