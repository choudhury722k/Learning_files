...
#define AI_FIRE_MODEL_SIGNATURE     "1c1804796d60f465fa70721840a19ff5"
...
#define AI_TOOLS_DATE_TIME   "Sat May 20 22:38:08 2023"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 8, 5, 1, 1), AI_STRIDE_INIT(4, 4, 32, 160, 160),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 52, 1,
                     NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_FIRE_IN_NUM, &serving_default_dense_input0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_FIRE_OUT_NUM, &nl_3_output),
